...
export default function Aichatpage() {
  ...
  const Characters = "AK";
        ...
        async function handleSubmit(e){
          ...
          try{
            const response = await fetch("http://localhost:9001/amazonproductdescription",{
              method:'POST',
              headers:{
...
<Link id='automate' onClick={handleMenuToggle} className='bg-white flex-row'>
        <div style={{marginLeft:'3ch'}} className='flex flex-row space-x-2 items-center'>
          ...
          <p>Amzaon Product Descriptions</p>
          </span>
         ...
         <span>
          <p>AI tool generates Amzaon Product Descriptions on user-defined parameters.</p>
         </span>
          </div> 
        </div>
</Link>
