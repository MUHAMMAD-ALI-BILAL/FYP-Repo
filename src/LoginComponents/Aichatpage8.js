...
export default function Aichatpage() {
  ...
  const Characters = "AK";
        ...
        async function handleSubmit(e){
          ...
          try{
            const response = await fetch("http://localhost:9001/youtubeIdeas",{
              method:'POST',
              headers:{
  ...
  return (
    ...
    <div style={{}} className='flex flex-row max-h-screen'>
      ...
      <div>
              ...
              <input className='rounded-lg' style={{padding:'0.7ch'}} value={input} onChange={handleChange1} placeholder='Introduction to cloud computing'></input>
              {showInput && 
              ...
              <input className='rounded-lg' style={{padding:'0.7ch'}} value={keyword} onChange={handleChange2} placeholder='What is cloud computing?'></input>
              {showKeyboard && 
          ...
          <div>
            <div style={{width:'90%', marginLeft:'auto', marginRight:'auto'}} className='flex flex-row space-x-7'>
              ...
              <div style={{width:'100%'}}> 
                <div className='flex flex-col'>
                <label className='text-white'>Max Character</label>
...
<Link id='automate' onClick={handleMenuToggle} className='bg-white flex-row'>
        <div style={{marginLeft:'3ch'}} className='flex flex-row space-x-2 items-center'>
         ...
         <span>
          <p>AI tool generates Youtube Ideas on user-defined parameters.</p>
         </span>
          </div> 
        </div>
</Link>
