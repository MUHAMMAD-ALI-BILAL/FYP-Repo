...
export default function Forgetverify() {
    ...
    const handleVerification = (e) => {
        ...
        e.preventDefault();
        console.log(code);
        axios.post("http://localhost:9000/forgotmail", { code: code }, {
            method:"POST",
            headers:{
          ...
          ((res) => {
            ...
            {
              console.log("User is verifed")
              navigate("/user/login/resetpassword")
    ...
    <div style={{width:'50%', marginLeft:'auto', marginRight:'auto' ,textAlign:'center', fontFamily: 'Roboto'}}>
        <div>
        <span style={{textAlign:'center', fontSize:'30px', fontWeight:"550"}}>Email Code Verification</span>
        </div>
        <div>
    ...
    <div style={{backgroundColor:'#111827', width:'40%',marginLeft:'auto', marginRight:'auto', marginTop:'2ch', paddingTop:'2ch', paddingBottom:'2ch', borderRadius:'1ch'}}>
        ...
        <div style={{display:'flex', padding:'2ch', justifyContent:'space-between'}}>
            <button style={{color:'#111827', backgroundColor:'#f55d35', width: 'fit-content', padding:'1ch', paddingLeft:'1.2ch', paddingRight:'1.2ch' ,borderRadius:'1ch'}} value={code} onClick={handleVerification}>Verify Code</button>
            <button style={{color:'#111827', backgroundColor:'#f55d35', width: 'fit-content', padding:'1ch', paddingLeft:'1ch', paddingRight:'1ch' ,borderRadius:'1ch'}} onClick={handleResend}>Resend Code Email</button>
        </div>
    </div>
